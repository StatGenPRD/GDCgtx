This repository provides background, instructions, and an example of how to run the routine PGx analysis pipeline (gtx R package) in GSK's Global Data Center (GDC).
